// Generated by gencpp from file cola2_msgs/GotoRequest.msg
// DO NOT EDIT!


#ifndef COLA2_MSGS_MESSAGE_GOTOREQUEST_H
#define COLA2_MSGS_MESSAGE_GOTOREQUEST_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::cola2_msgs::GotoRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::cola2_msgs::GotoRequest_<ContainerAllocator> const> ConstPtr;

}; // struct GotoRequest_

typedef ::cola2_msgs::GotoRequest_<std::allocator<void> > GotoRequest;

typedef boost::shared_ptr< ::cola2_msgs::GotoRequest > GotoRequestPtr;
typedef boost::shared_ptr< ::cola2_msgs::GotoRequest const> GotoRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::cola2_msgs::GotoRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cola2_msgs::GotoRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::cola2_msgs::GotoRequest_<ContainerAllocator1> & lhs, const ::cola2_msgs::GotoRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::cola2_msgs::GotoRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cola2_msgs::GotoRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cola2_msgs::GotoRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cola2_msgs::GotoRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cola2_msgs::GotoRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cola2_msgs::GotoRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::cola2_msgs::GotoRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::cola2_msgs::GotoRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x99d15622a6bf183fULL;
  static const uint64_t static_value2 = 0x635ce6a1882f2224ULL;
};

template<class ContainerAllocator>
struct DataType< ::cola2_msgs::GotoRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::cola2_msgs::GotoRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Final state\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cola2_msgs::GotoRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::cola2_msgs::GotoRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cola2_msgs::GotoRequest_<ContainerAllocator>& v)
  {
    s << indent << "final_x: ";
...
#endif // COLA2_MSGS_MESSAGE_GOTOREQUEST_H
