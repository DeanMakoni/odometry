...
class PilotActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new PilotFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PilotActionFeedback
    ...
    bufferOffset = PilotFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PilotActionFeedback
    let len;
    let data = new PilotActionFeedback(null);
    ...
    data.feedback = PilotFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PilotActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PilotFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PilotFeedback()
    }
...
module.exports = PilotActionFeedback;
