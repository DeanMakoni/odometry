...
(cl:defclass <DVL> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (beams
    :reader beams
    :initarg :beams
    :type (cl:vector uuv_sensor_ros_plugins_msgs-msg:DVLBeam)
   :initform (cl:make-array 0 :element-type 'uuv_sensor_ros_plugins_msgs-msg:DVLBeam :initial-element (cl:make-instance 'uuv_sensor_ros_plugins_msgs-msg:DVLBeam))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DVL>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DVL)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uuv_sensor_ros_plugins_msgs-msg:<DVL> is deprecated: use uuv_sensor_ros_plugins_msgs-msg:DVL instead.")))
...
(cl:defmethod velocity-val ((m <DVL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_sensor_ros_plugins_msgs-msg:velocity-val is deprecated.  Use uuv_sensor_ros_plugins_msgs-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'velocity_covariance-val :lambda-list '(m))
(cl:defmethod velocity_covariance-val ((m <DVL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_sensor_ros_plugins_msgs-msg:velocity_covariance-val is deprecated.  Use uuv_sensor_ros_plugins_msgs-msg:velocity_covariance instead.")
  (velocity_covariance m))

(cl:ensure-generic-function 'altitude-val :lambda-list '(m))
(cl:defmethod altitude-val ((m <DVL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_sensor_ros_plugins_msgs-msg:altitude-val is deprecated.  Use uuv_sensor_ros_plugins_msgs-msg:altitude instead.")
  (altitude m))

(cl:ensure-generic-function 'beams-val :lambda-list '(m))
(cl:defmethod beams-val ((m <DVL>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_sensor_ros_plugins_msgs-msg:beams-val is deprecated.  Use uuv_sensor_ros_plugins_msgs-msg:beams instead.")
  (beams m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DVL>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'beams)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'uuv_sensor_ros_plugins_msgs-msg:DVLBeam))
